...
public class Client3 {
    ...
    public static void main(String args[]) {
        ...
        final Logger LOGGER = LoggerFactory.getLogger(Client3.class);
        try {
            ...
            LOGGER.info("Client connected and requested to execute Top 100 authors withouts co-authors task: ");
